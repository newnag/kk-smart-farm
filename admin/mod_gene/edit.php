			...
			<div class="card">
				...
				<div class="card-body" id="idBoxBody<?php echo $box; ?>">
					...
					<div class="form-group">
						<label class="mb-0 text-grey-800 font-weight-bold">ชื่อสายพันธุ์ : </label>
						<input id="inputGene" name="inputGene" type="text" class="form-control" value="<?php echo $Row["name"]; ?>">
					</div>
					<!-- ------------------------------------------------------- -->
				</div>
			</div>
