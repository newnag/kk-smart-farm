			...
			<div class="card">
				...
				<div class="card-body" id="idBoxBody<?php echo $box; ?>">
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputTitle1" name="inputTitle1" type="text" class="form-control" value="<?php echo $Row["title1"]; ?>">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<textarea name="inputHTML1" id="inputHTML1" class="inputHTML" rows="4" cols="4" style=" width: 100%; height: 400px; ">
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputTitle2" name="inputTitle2" type="text" class="form-control" value="<?php echo $Row["title2"]; ?>">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<textarea name="inputHTML2" id="inputHTML2" class="inputHTML" rows="4" cols="4" style=" width: 100%; height: 400px; ">
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputTitle3" name="inputTitle3" type="text" class="form-control" value="<?php echo $Row["title3"]; ?>">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<textarea name="inputHTML3" id="inputHTML3" class="inputHTML" rows="4" cols="4" style=" width: 100%; height: 400px; ">
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputTitle4" name="inputTitle4" type="text" class="form-control" value="<?php echo $Row["title4"]; ?>">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<textarea name="inputHTML4" id="inputHTML4" class="inputHTML" rows="4" cols="4" style=" width: 100%; height: 400px; ">
