			...
			<div class="card">
				...
				<div class="card-body" id="idBoxBody<?php echo $box; ?>">
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputDateGive" name="inputDateGive" type="text" class="form-control" required>
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<input id="inputHistoryGive" name="inputHistoryGive" type="text" class="form-control" required>
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<input id="inputBreastFeed" name="inputBreastFeed" type="number" class="form-control" required>
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<input id="inputDateRut" name="inputDateRut" type="text" class="form-control" required>
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<input id="inputSymtom" name="inputSymtom" type="text" class="form-control" required>
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group">
						...
						<select class="form-control select select2-hidden-accessible" id="inputRutChoice" name="inputRutChoice" data-fouc="" tabindex="-1" aria-hidden="true">
							<option value="">ลักษณะเมือก</option>
							<?php 
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputRutDetail" name="inputRutDetail" type="text" class="form-control">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
						...
						<input id="inputAbSymtom" name="inputAbSymtom" type="text" class="form-control">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group">
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputTreatmentDetail" name="inputTreatmentDetail" type="text" class="form-control">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group">
