...
include_once("../inc/inc_page_header.php");
	...
	#sortable li { margin: 3px 3px 3px 0; padding: 4px; float: left; width: <?php echo MODULE_FIX_WIDTH; ?>px; height: <?php echo MODULE_FIX_HEIGHT+50; ?>px; cursor: pointer; margin-bottom: 10px; }
