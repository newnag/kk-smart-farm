						...
						<div class="form-group" style=" width:170px; ">
							<select id="inputShowOrderBy" name="inputShowOrderBy" class="form-control select FilterSearch" data-fouc>
								<optgroup label="เรียงตาม">
									<option value="Order" <?php if($_REQUEST["inputShowOrderBy"]=="Order") { echo ' selected '; } ?>> การเรียงลำดับ </option>
									<option value="ID" <?php if($_REQUEST["inputShowOrderBy"]=="ID") { echo ' selected '; } ?>> วันที่สร้าง </option>
									<option value="LastUpdate" <?php if($_REQUEST["inputShowOrderBy"]=="LastUpdate") { echo ' selected '; } ?>> วันที่แก้ไข </option>
									<option value="Name" <?php if($_REQUEST["inputShowOrderBy"]=="Name") { echo ' selected '; } ?>> ชื่อกลุ่ม </option>
									<option value="CodeName" <?php if($_REQUEST["inputShowOrderBy"]=="CodeName") { echo ' selected '; } ?>> รหัสกลุ่ม </option>
								</optgroup>
							</select>
						</div>
                    </li>
