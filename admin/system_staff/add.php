						...
						<div class="form-check form-check-inline mr-4">
							<label class="form-check-label" style=" line-height: 25px; ">
								<div class="uniform-choice">
									...
									<input type="radio" class="form-input-styled" name="inputLevel" checked="" data-fouc="" value="Administrator" >
									</span>
								</div>
								Administrator
							</label>
						...
						<div class="form-check form-check-inline mr-4">
							<label class="form-check-label" style=" line-height: 25px; ">
								<div class="uniform-choice">
									...
									<input type="radio" class="form-input-styled" name="inputLevel" data-fouc="" value="Staff" >
									</span>
								</div>
								Staff
							</label>
			...
			<div class="card <?php echo CONFIG_DEFAULT_DESIGN_CLASS2; ?>">
				...
				<div class="card-body" id="idBoxBody<?php echo $box; ?>" style=" display: none; ">
					...
					<div class="form-group" style=" margin-top: 10px; ">
						...
						<input id="inputPhone" name="inputPhone" type="text" class="form-control text-white">
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group">
						<?php
