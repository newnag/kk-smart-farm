...
# PreLoadInput
#-------------------------------------------------------------------
if($_REQUEST["inputType"]=="") { $_REQUEST["inputType"]="Nutrition"; }
			...
			<div class="card">
				...
				<div class="card-body" id="idBoxBody<?php echo $box; ?>">
					...
					<div class="form-group" style=" margin-top: 20px; ">
						...
						<input id="inputAgeRange" name="inputAgeRange" type="text" class="form-control" value="<?php echo $Row["Title"]; ?>" required>
					</div>
					<!-- ------------------------------------------------------- -->
					<div class="form-group" style=" margin-top: 20px; ">
						<label class="mb-0 text-grey-800 font-weight-bold">
