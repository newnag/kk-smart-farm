...
try {
	...
	$sql.=" ".TABLE_MOD_BANNERHERO4."_Name=? ";            $arSQLData[]=$inputName;
	if($inputPicture<>"") {
		$sql.=",".TABLE_MOD_BANNERHERO4."_Picture=? ";     $arSQLData[]=$inputPicture;
	}
	$sql.=",".TABLE_MOD_BANNERHERO4."_LastUpdate=? ";      $arSQLData[]=SYSTEM_DATETIMENOW;
	$sql.=",".TABLE_MOD_BANNERHERO4."_LastUpdateByID=? ";  $arSQLData[]=$SystemSession_Staff_ID;
	$sql.=",".TABLE_MOD_BANNERHERO4."_Status=? ";          $arSQLData[]=$inputStatus;
