...
#-------------------------------------------------------------------
try {
	$sql =" SELECT * FROM ".TABLE_MOD_SUBCATEGORY." WHERE ".TABLE_MOD_SUBCATEGORY."_status<>'Deleted' ORDER BY ".TABLE_MOD_SUBCATEGORY."_cateName ,".TABLE_MOD_SUBCATEGORY."_name ASC" ;
