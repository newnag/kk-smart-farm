...
try {
	...
	$sql.=" ".TABLE_MOD_BANNERHERO."_Name=? ";            $arSQLData[]=$inputName;
	if($inputPicture<>"") {
		$sql.=",".TABLE_MOD_BANNERHERO."_Picture=? ";     $arSQLData[]=$inputPicture;
	}
	...
	$sql.=",".TABLE_MOD_BANNERHERO."_Status=? ";          $arSQLData[]=$inputStatus;
