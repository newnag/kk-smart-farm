...
include_once("../inc/inc_page_header.php");
				...
				<div class="row" id="idListBody" style=" margin-top: 10px; ">
					<div class="col-sm-12 col-md-12 col-lg-12" style=" text-align: center; ">
						<div style=" width: 600px; margin: auto; ">
							<ul id="sortable" style=" width: <?php echo MODULE_FIX_WIDTH_THUMB; ?>px; margin: auto; ">
								<?php
	...
	#sortable li { margin: 3px 3px 3px 0; padding: 4px; float: left; cursor: pointer; margin-bottom: 10px; }
